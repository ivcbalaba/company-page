...
var serviceTitleTextArea = document.getElementById("service-text");
...
nextArrow.onclick = function () {
  ...
  var servicesTitle = ourServices[currentService].title;
  var servicesText = ourServices[currentService].text;

  serviceTitleArea.innerHTML = servicesTitle;
  serviceTitleTextArea.innerHTML = servicesText;
